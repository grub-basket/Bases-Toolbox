    ...
    const groups: { title: string; note?: string; items: [string, string][] }[] = [
      {
        ...
        items: [
          ...
          ["Frontmatter (properties & values) History", "Browse past property/value/frontmatter operations and revert them individually or in full."],
      ...
      },
      {
        ...
        items: [
          ...
          ["Frontmatter (properties & values) history", "Open the revert log."],
